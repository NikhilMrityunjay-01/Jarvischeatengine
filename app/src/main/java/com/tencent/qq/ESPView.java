...
public class ESPView extends View implements Runnable {
    ...
    protected void onDraw(Canvas canvas) {
        if (canvas != null && getVisibility() == VISIBLE) {
            ...
            if (getHeight() == 720 && getWidth() == 1280) {
                DrawText(canvas, 255, 0, 255, 0, "                              " +"JARVIS INT", 650, 150, 28);
            }
            else {
                DrawText(canvas, 255, 0, 255, 0, "        " +"JARVIS INT", 650, 150, 28);
            }
    ...
    private String getItemName(String s) {
        ...
        if (s.contains("MZJ_HD") && getConfig("REDDOT")) { mTextPaint.setARGB(255, 230, 172, 226);
            return "Red Dot";
        }
        ...
        if (s.contains("SCAR") && getConfig("SCARL")) { mTextPaint.setARGB(255, 0, 255, 0);
            return "SCAR-L";
        }
        ...
        if (s.contains("TommyGun") && getConfig("TOMMY")) { mTextPaint.setARGB(255, 0, 0, 207);
            return "TommyGun";
        }
...
//shotguns and hand weapons
        ...
        if (s.contains("Ammo_300Magnum") && getConfig("MAGNUM")) { mTextPaint.setColor(Color.BLACK);
            return "300Magnum";
        }

        if (s.contains("Ammo_12Guage") && getConfig("GUAGEe")) { mTextPaint.setARGB(255, 156, 91, 81);
            return "12 Guage";
        }
        ...
        //bag helmet vest
        if (s.contains("Bag_Lv3") && getConfig("BAG-3")) { mTextPaint.setARGB(255, 36, 83, 255);
            return "Bag lvl 3";
        }

        if (s.contains("Bag_Lv1")  && getConfig("BAG-1")) { mTextPaint.setARGB(255, 127, 154, 250);
            return "Bag lvl 1";
        }

        if (s.contains("Bag_Lv2") && getConfig("BAG-2")) { mTextPaint.setARGB(255, 77, 115, 255);
            return "Bag lvl 2";
        }

        if (s.contains("Armor_Lv2") && getConfig("VEST-2")) { mTextPaint.setARGB(255, 77, 115, 255);
            return "Vest lvl 2";
        }


        if (s.contains("Armor_Lv1") && getConfig("VEST-1")) { mTextPaint.setARGB(255, 127, 154, 250);
            return "Vest lvl 1";
        }


        if (s.contains("Armor_Lv3") && getConfig("VEST-3")) { mTextPaint.setARGB(255, 36, 83, 255);
            return "Vest lvl 3";
        }
        ...
        if (s.contains("Firstaid") && getConfig("fIRST AID KIT")) { mTextPaint.setARGB(255, 194, 188, 109);
            return "FirstAidKit";
        }
        ...
        if (s.contains("FirstAidbox") && getConfig("MEDKKIT")) { mTextPaint.setARGB(255, 0, 171, 6);
            return "Medkit";
        }
        ...
        if (s.contains("Grenade_Burn") && getConfig("MOLTOV")) { mTextPaint.setARGB(255, 230, 175, 64);
            return "Molotov";
        }
        ...
        if (s.contains("Ghillie") && getConfig("GHILLIE")) { mTextPaint.setARGB(255, 139, 247, 67);
            return "Ghillie Suit";
        }
        ...
        if ((s.contains("AirDrop")  )&& getConfig("AIR DROP")) { mTextPaint.setARGB(255, 255, 10, 255);
            return "AirDrop";
        }
        //return s;
        return null;
