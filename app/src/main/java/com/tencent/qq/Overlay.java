...
static Context ctx;
    ...
    public void onCreate() {
        ...
        if (MainActivity6.gameType == 1) {
            Start(ctx,1,1);

        }
        else if (MainActivity6.gameType == 2) {
            Start(ctx,2,1);

        }
        else if (MainActivity6.gameType == 3) {
            Start(ctx,3,1);

        }
        else if (MainActivity6.gameType == 4) {
            Start(ctx,4,1);

        }
        else if (MainActivity6.gameType == 5) {
            Start(ctx,5,1);
